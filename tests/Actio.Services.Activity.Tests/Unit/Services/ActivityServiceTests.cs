...
namespace Actio.Services.Activity.Tests.Unit.Services
{
    public class ActivityServiceTests
    {
        ...
        public async Task activity_service_add_async_should_succeed()
        {
            ...
            activityRepositoryMock.Verify(x => x.AddAsync(It.IsAny<Actio.Services.Activities.Domain.Models.Activity>()), Times.Once);
        }
    }
}